    ...
    >
      <div className="flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <div className="ml-4 flex items-center py-2 px-4 rounded-md bg-gradient-to-r from-[#2F4858] to-[#3A5A6B] text-white">
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="mt-4 p-4 bg-gradient-to-r from-[#2F4858] to-[#3A5A6B] text-white rounded-md">
              Consultation <MdOutlineArrowRight className="ml-2 inline" />
            </div>
          </motion.div>
        )}
      </AnimatePresence>
